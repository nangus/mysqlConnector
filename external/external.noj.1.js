...
var argv    = process.argv.copyArgs();
...
function readMysqlConfig(name){
    ...
    var conf=[];
     ...
     require(name);
         ...
         console.log('unable to load mysql config file.');
         phantom.exit();
     }
}
var json      = argv.getArg(['--json', '-j'], false);
var mysqlFile = argv.getArg(['--mysql', '-m'], true);
var mysqlConfig = false;
console.log(mysqlConfig);
phantom.exit();

var addresses = util.parsePaths(argv.shift());
var excludes  = util.parsePaths(argv.shift());
var finished  = 0;
